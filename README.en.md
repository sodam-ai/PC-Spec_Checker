...
> 📘 **New here? → Read the [Complete Beginner's Guide (GUIDE.en.md)](./GUIDE.en.md)** (PDF: `GUIDE.en.pdf`)
...
See the **[Complete Beginner's Guide](./GUIDE.en.md)** for a detailed explanation of each item.
...
More questions and fixes are in the **[guide's troubleshooting section](./GUIDE.en.md#16-troubleshooting--error-handling)**.
...
|---|---|
| [README.en.md](./README.en.md) / [README.md](./README.md) | EN/KO intro (this file) |
| [GUIDE.en.md](./GUIDE.en.md) / [GUIDE.md](./GUIDE.md) | EN/KO complete beginner's guide |
...
Full text in [`LICENSE`](./LICENSE); a plain-language explanation is in [guide section 21](./GUIDE.en.md#21-license--copyright--commercial-use).
