...
> 📘 **처음이신가요? → [완전 초보자 가이드 (GUIDE.ko.md)](./GUIDE.ko.md)** 를 보세요. (PDF: `GUIDE.ko.pdf`)
...
각 항목의 자세한 설명은 **[완전 초보자 가이드](./GUIDE.ko.md)** 를 참고하세요.
...
더 많은 질문과 문제 해결은 **[가이드의 문제 대처](./GUIDE.ko.md#16-문제-대처--오류-대처)** 를 참고하세요.
...
| 문서 | 설명 |
|---|---|
| [README.ko.md](./README.ko.md) / [README.md](./README.md) | 한/영 소개 (지금 이 문서) |
| [GUIDE.ko.md](./GUIDE.ko.md) / [GUIDE.md](./GUIDE.md) | 한/영 완전 초보자 가이드 |
...
전문은 [`LICENSE`](./LICENSE) 파일, 쉬운 설명은 [가이드 21번](./GUIDE.ko.md#21-라이선스--저작권--상업적-이용) 참고.
